...
public class GetDriverNameData implements  Parcelable
{
    ...
    public final static Parcelable.Creator<GetDriverNameData> CREATOR = new Creator<GetDriverNameData>() {


        @SuppressWarnings({
                "unchecked"
        })
        public GetDriverNameData createFromParcel(Parcel in) {
            return new GetDriverNameData(in);
        }

        public GetDriverNameData[] newArray(int size) {
            return (new GetDriverNameData[size]);
        }
    ...
    protected GetDriverNameData(Parcel in) {
